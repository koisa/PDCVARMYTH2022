...
% Physiology, Insights in Information Theory: 2021**:
% 
...
for k = [2 3 1 4]
   ...
   switch k
      ...
      case 1
         ...
         [pdct,pdc,pdcr,pdcp,spdc,y0i] = pdc_tot_p(ct.cpdc,pf);
      ...
      case 2
         ...
         [pdct,pdc,pdcr,pdcp,spdc,y0i] = pdc_tot_p(ctx.cpdc,pfx);
      ...
      case 3
         ...
         [pdct,pdc,pdcr,pdcp,spdc,y0i] = pdc_tot_p(cy.cpdc,pfa);
      ...
      case 4
         ...
         [pdct,pdc,pdcr,pdcp,spdc,y0i] = pdc_tot_p(ctz.cpdc,Sigma);
